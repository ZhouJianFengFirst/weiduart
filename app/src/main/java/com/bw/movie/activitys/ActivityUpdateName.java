...
import com.bw.movie.persenter.ActivityUpdateNamePersenter;
...
public class ActivityUpdateName extends BaseActivity<ActivityUpdateNamePersenter> {
    
    @Override
    public Class<ActivityUpdateNamePersenter> getDelegateClass() {
        //返回本页面的Persenter类
        return ActivityUpdateNamePersenter.class;
    }
