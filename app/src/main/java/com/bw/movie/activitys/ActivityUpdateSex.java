...
import com.bw.movie.persenter.ActivityUpdateSexPersenter;
...
public class ActivityUpdateSex extends BaseActivity<ActivityUpdateSexPersenter> {

    @Override
    public Class<ActivityUpdateSexPersenter> getDelegateClass() {
        //返回本页面的类
        return ActivityUpdateSexPersenter.class;
    }
